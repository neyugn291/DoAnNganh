...
const Register = () => {
    ...
    const validate = () => {
        ...
        for (let field of requiredFields) {
            if (!(field in user) || user[field] === "") {
                setError(
                    `Vui lòng nhập ${field === "confirm" ? "xác nhận mật khẩu" : field
                    }!`
                );
                return false;
            }
    ...
    const register = async () => {
        ...
        try {
            ...
            // Tạo object JSON từ dữ liệu user
            const payload = {
            ...
            console.log("Payload JSON gửi lên:", payload);

            const registerResponse = await Apis.post(endpoints["users"], payload, {
        ...
        <View style={myStyles.container}>
            <View style={myStyles.card}>
                ...
                <TextInput
                    ...
                    onChangeText={(text) => setState(text, "phone_number")}
